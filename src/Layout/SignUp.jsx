...
const SignUp = () => {
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-[var(--color-one)] to-[var(--color-two)] p-6">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
            ...
            {step === 1 && (
              <>
                ...
                <button type="submit" className="bg-blue-500 text-white cursor-pointer hover:bg-blue-900 p-2 rounded w-full">
                  Next
                </button>
              </>
            )}
              ...
              <div className="flex flex-col gap-3 relative">
                ...
                <div className="flex justify-between">
                  <button
                    ...
                    className="bg-gray-400 cursor-pointer hover:bg-gray-600 text-white p-2 rounded"
                  >
                    Back
                  </button>
                  <button type="submit" className="bg-blue-500 text-white cursor-pointer hover:bg-blue-900 p-2 rounded">
                    Next
                  </button>
                </div>
              </div>
